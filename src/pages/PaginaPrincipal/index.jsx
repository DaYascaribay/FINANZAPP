                        ...
                        <div className="ml-[248px] h-[4px] w-[10%] rounded-t1-[1px] rounded-tr-[1px] bg-white-a700 md:ml-0" /> 
                            <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
                                ...
                                <div className="flex gap-6">
                                    <a href="/CrearCuenta"> 
                                        <Button size="sm" as = "p" className="min-w-[98px] rounded font-cabin bg-green-300 px-8 py-2 !text-white-a700 hover:bg-green-600"> 
                                            Crear cuenta{" "} 
                                        </Button>
                                    </a>
                                    <a href="/IniciarSesion"> 
                                        <Button size="sm" as = "p" className="min-w-[98px] rounded font-cabin bg-white-a700 px-8 py-2 !text-green-400 hover:bg-gray-300"> 
                                            Iniciar sesión
                                        </Button>
                                    </a>
                                </div> 
