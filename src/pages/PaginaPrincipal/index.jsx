...
const data = [
    {
        userimage: "images/img_icono_1.svg",
        mejorcontrolfin: "Mejor control financiero",
        description:
            "Al tener la posibilidad de tener un seguimiento de los registros de todos los gastos que se realicen se podrá identificar patrones para realizar enfoques de mejora.",
    },
    {
    ...
    },
    {
        ...
        mejorcontrolfin: "Mejorar la conciencia financiera",
        description:
    ...
    },
    {
        ...
        description:
            "La aplicación motiva a los usuarios a ahorrar para cuidar su dinero y alcanzar metas financieras. Visualizar los gastos permite identificar pequeñas oportunidades de ahorro.",
    },
    {
        userimage: "images/img_icono_1.svg",
        mejorcontrolfin: "Mejor control financiero",
...
=======
>>>>>>> 903d901ff266bd96ef6faeaeec6a2f2889eca606
];
const data1 = [
    {
        ...
        logolinkedin: "images/img_logo_linkedin.svg",
        logotwitterone: "images/img_logo_twitter.svg",
        logoinstagram: "images/img_logo_instagram.svg",
    },
    {
            ...
            <div className="w-full bg-white-a700 shadow-xs">
                <header className="flex items-start justify-center bg-green-400 px-10 shadow-sm sm:px-5">
                    <div className="mb-3 flex w-[92%] flex-col items-start gap-2 md:w-full">
                        <div className="ml-[248px] h-[4px] w-[10%] rounded-tl-[1px] rounded-tr-[1px] bg-white-a700 md:ml-0" />
                            ...
                            <div className="container-xs mt-2.5 flex justify-center px-14 md:p-5 md:px-5">
                                <div className="flex w-[60%] flex-col items-center gap-[76px] md:w-full md:gap-[57px] sm:gap-[38px]">
                                    ...
                                    <div className="flex gap-12 self-stretch md:flex-col">
                                        <PaginaPrincipalContainerplan className="items-start border border-solid border-gray-300 bg-white-a700 md:w-full sm:p-5" />
                                        <PaginaPrincipalContainerplan className="gap-[70px] bg-green-600 md:w-full md:gap-[52px] sm:gap-[35px] sm:p-5" />
                                    </div>
                                </div>
                            </div>
                        </div>
