                    ...
                    <div>
                        <div className="flex flex-col gap-8">
                            <div className="flex flex-col items-start gap-9">
                                ...
                                <div className="self-stretch rounded-lg border border-solid border-gray-300 bg-white-a700 p-6 sm:p-5"> 
                            ...
                            <div className="ml-1.5 mr-1 flex gap-8 md:mx-0 md:flex-col">
                                <div className="flex-1 md:self-stretch">
                                    <div className="flex flex-col items-start rounded-lg border border-solid border-gray-300 bg-white-a780 px-6 py-[26px] sm:p-5"> 
                                        <Text size="textxl" as="p" className="ml-1.5 font-cabin text-blue_gray-900 md:ml-0"> 
                                            Resumen mensual
                                        </Text>
                                        <Text as="p" className="ml-1.5 mt-5 font-medium text-blue_gray-500 md:ml-0">
                                            Este mes
                                        </Text>
                            ...
                            <div className="w-[34%] md:w-full">
                                <div className="flex flex-col items-start gap-5 rounded-lg border border-solid border-gray-300 bg-white-a700 p-[30px] sm:p-5"> 
                                    <Text size="textxl" as="p" className="font-cabin text-blue_gray-900"> 
                                        Vista general
                                    </Text>
