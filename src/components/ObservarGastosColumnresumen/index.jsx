    ...
    return (
        <div {...props} className={`${props.className} flex flex-col gap-[26px]`}>
            ...
            <div className="flex gap-6 self-stretch">
                <div className="flex w-full flex-col items-start justify-center gap-[18px] rounded-lg bg-gray-100_02 px-6 pу-[26px] sm: gap-[18px] sm:p-5"> 
                ...
                <div className="flex w-full flex-col items-start justify-center gap-[18px] rounded-1g bg-yellow-50 px-6 py-[26px] sm:gap-[18px] sm:p-5"> 
                    <Text size="textmd" as="p" className="!text-blue_gray-900_02 sm:text-[13px]">
                        {dinero}
                    </Text>
